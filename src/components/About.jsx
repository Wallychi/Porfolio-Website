...
const About = () => {
    return (
        <section id='about' className='flex flex-col px-5 py-10 pt-20 gap-4 border-b-1 border-[var(--color-secondary)]'>
            ...
            <h1 className='text-4xl font-semibold'>MY CAPABILITIES</h1>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <div className='flex flex-col gap-2'>
                    <div className='flex flex-col gap-1'>
                        <p className='text-xl'>Freelance Developer</p>
                        <p className='text-lg text-[var(--color-tertiary)]'>Mar 2025 - Till Date</p>
                    </div>
                ...
                <div className='flex flex-col gap-2'>
                    <div className='flex flex-col gap-1'>
                        <p className='text-xl'>Front-End Intern</p>
                        <p className='text-lg text-[var(--color-tertiary)]'>Mar 2025 - Jan 2026</p>
                        <p className='text-[var(--color-extra)] font-semibold'>Larva Coding Academy</p>
                    </div>
