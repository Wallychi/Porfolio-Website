...
const About = () => {
    return (
        <section id='about' className='flex flex-col px-5 lg:px-15 py-10 pt-20 gap-7 lg:gap-15 border-b-1 border-[var(--color-secondary)]'>
            <div className='flex flex-col lg:flex-row gap-3 lg:gap-0'>
                <h1 className='text-4xl lg:text-5xl font-serif font-bold lg:basis-1/2'>
                    ABOUT ME
                </h1>
            ...
            <div className='flex flex-col lg:flex-row gap-3 lg:gap-0'>
                <h1 className='text-4xl lg:text-5xl lg:basis-1/2 font-serif font-bold'>MY CAPABILITIES</h1>
            ...
            <div className='flex flex-col lg:flex-row gap-5 lg:gap-0'>
                <h1 className='text-4xl lg:text-5xl font-serif font-bold lg:basis-1/2'>MY EXPERIENCE</h1>
            ...
            <div className='flex flex-col lg:flex-row gap-3 lg:gap-0'>
                <h1 className='text-4xl lg:text-5xl font-serif font-bold lg:basis-1/2'>MY EDUCATION</h1>

                
                <div className='flex flex-col gap-1 lg:gap-2 lg:basis-1/2 text-[var(--color-tertiary)]'>
